...
export default class Statement {
  ...
  */
  ...
  equals (other) {
    return rdfFactory.equals(other.subject, this.subject)
      && rdfFactory.equals(other.predicate, this.predicate)
      && rdfFactory.equals(other.object, this.object)
      && rdfFactory.equals(other.graph, this.graph)
  }
  substitute (bindings) {
