...
declare module "rdflib" {
   ...
   */
  export type RequestCallbackHandler = (uri: string | CoreNamedNode, error?: Error) => boolean | undefined;

  export type SomeTerm = CoreNode | CoreLiteral;

  export type OptionalNode = CoreNode | null | undefined;
  export type OptionalTerm = CoreNode | CoreLiteral | null | undefined;
  ...
  export class Node<RDFBase = {}> {
    ...
    public static compareTerm(other: CoreNode): number;

    public static equals(one: CoreNode, other: CoreNode): boolean;

    public static hashString(node: Node): string;

    public static sameTerm(node: Node, other: CoreNode): boolean;

    public static toCanonical(node: Node): string;

    public static toNT(node: Node): string;

    public static toString(node: Node): string;
  }

  export class NamedNode extends Node implements CoreNamedNode {
    public readonly termType: TermType.NamedNode;
    ...
    public static dir(n: CoreNamedNode): string;

    public static doc(n: CoreNamedNode): CoreNamedNode;

    public static site(n: CoreNamedNode): CoreNamedNode;
  }
  ...
  export class Literal extends Node implements CoreLiteral {
    ...
    public readonly termType: TermType.Literal;
  ...
  export class BlankNode extends Node implements CoreBlankNode {
    public readonly termType: TermType.BlankNode;
